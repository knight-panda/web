    ...
    return (
        <footer className="admin-footer">
            <div className="admin-footer-container">
                ...
                <div className="admin-footer-section about">
                ...
                <div className="admin-footer-section links">
                    <h3>Company</h3>
                    <ul>
                ...
                <div className="admin-footer-section categories">
                    <h3>Top Services</h3>
                    <ul>
                ...
                <div className="admin-footer-section contact">
                    <h3>Contact Us</h3>
